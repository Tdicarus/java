package android.sv61133478.calculator_constraint;
...
public class MainActivity extends AppCompatActivity {
    ...
    {
        NutCong = (Button) findViewById(R.id.Cong);
        NutTru = (Button) findViewById(R.id.Tru);
        NutNhan = (Button) findViewById(R.id.Nhan);
        NutChia = (Button) findViewById(R.id.Chia);
    }
